...
function usage() {
  console.log(`Usage:
  node <agent-context.mjs> feature --feature S07 [--workflow route] [--format markdown|json|toon] [--no-manifest]
  node <agent-context.mjs> item --item S07-TASK-01 [--workflow route] [--format markdown|json|toon] [--no-manifest]
  node <agent-context.mjs> audit
  node <agent-context.mjs> next [--feature S07] [--workflow route] [--type task] [--max-items 1] [--format markdown|json|toon]
  node <agent-context.mjs> loop --feature S07 --workflow route --max-items 3 [--format markdown|json]
