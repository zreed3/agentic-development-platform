...
function usage() {
  console.log(`Usage:
  node <adg-elicitation.mjs> validate [--config config/agentic/elicitation.json] [--feature S07] [--format json|markdown|toon] [--no-sqlite]
  node <adg-elicitation.mjs> packet --feature S07 [--format json|markdown|toon]
  node <adg-elicitation.mjs> graph [--feature S07] [--format json|markdown|toon]
